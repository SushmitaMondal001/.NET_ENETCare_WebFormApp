...
<body>
    <form id="form1">
        <div style="height: 853px; width: 1450px">
            ...
            <asp:DropDownList ID="clientNameDropDownList" runat="server" style="z-index: 1; left: 440px; top: 410px; position: absolute; width: 333px" Visible="True" EnableViewState="true">
            </asp:DropDownList>
